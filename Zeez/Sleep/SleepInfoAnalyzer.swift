...
class SleepInfoAnalyzer {
    ...
    private func calculateDurationScore() -> Double {
        let targetDuration: TimeInterval = AppConstants.Sleep.targetDuration // 8 hours
    ...
    private func calculateComparison() -> ComparisonMetrics {
        ...
        let sleepGoal = preferences?.targetSleepDuration ?? AppConstants.Sleep.targetDuration // Default 8 hours
    ...
    private func calculateConsistencyScore() -> Double {
        ...
        let maxVariance: TimeInterval = AppConstants.Sleep.maxConsistencyVariance // 2 hours variance = 0% consistency
