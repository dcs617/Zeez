...
struct SleepCycleInfoView: View {
        ...
        NavigationView {
            ...
            .toolbar {
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    .accessibilityLabel("Close sleep cycle information")
                    .accessibilityHint("Return to previous screen")
                    .accessibilityIdentifier("closeSleepCycleInfoButton")
                }
            }
        }
    }
    ...
    private var introSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text("What are Sleep Cycles?")
                .font(.headline)
                .accessibilityLabel("What are sleep cycles? Introduction section")
                .accessibilityIdentifier("sleepCyclesIntroTitle")
            ...
            Text("During sleep, your body goes through multiple cycles of different sleep stages. Each cycle typically lasts around 90 minutes, and a good night's sleep consists of 4-6 complete cycles.")
                ...
                .accessibilityLabel("During sleep, your body goes through multiple cycles of different sleep stages. Each cycle typically lasts around 90 minutes, and a good night's sleep consists of 4-6 complete cycles.")
                .accessibilityIdentifier("sleepCyclesIntroDescription")
        }
        .accessibilityElement(children: .combine)
        .accessibilityIdentifier("introSection")
    }
    ...
    private var stagesSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Sleep Stages")
                .font(.headline)
                .accessibilityLabel("Sleep stages section")
                .accessibilityIdentifier("sleepStagesTitle")
            ...
            ForEach(stages, id: \.name) { stage in
                VStack(alignment: .leading, spacing: 8) {
                    HStack {
                        Image(systemName: stage.icon)
                            ...
                            .accessibilityLabel("\(stage.name) icon")
                ...
                .accessibilityElement(children: .combine)
                .accessibilityLabel("\(stage.name): \(stage.description)")
                .accessibilityIdentifier("sleepStage_\(stage.name.replacingOccurrences(of: " ", with: ""))")
            }
        }
        .accessibilityElement(children: .combine)
        .accessibilityIdentifier("stagesSection")
    }
    ...
    private var tipsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Tips for Better Sleep Cycles")
                .font(.headline)
                .accessibilityLabel("Tips for better sleep cycles section")
                .accessibilityIdentifier("sleepCycleTipsTitle")
    ...
    private func tipRow(icon: String, title: String, description: String) -> some View {
        ...
        .accessibilityElement(children: .combine)
        .accessibilityLabel("Tip: \(title). \(description)")
        .accessibilityIdentifier("tip_\(title.replacingOccurrences(of: " ", with: ""))")
    }
}
