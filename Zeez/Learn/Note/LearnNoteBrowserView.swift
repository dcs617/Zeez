...
struct LearnNoteBrowserView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Notes browser")
        .accessibilityHint("Browse, search, and manage your sleep learning notes")
        .accessibilityIdentifier("notesBrowserView")
        ...
        .toolbar {
            ToolbarItemGroup(placement: .navigationBarLeading) {
                ...
                .accessibilityHint(isSelectionMode ? "Exit multi-select mode" : "Select multiple notes for batch operations")
                .accessibilityIdentifier("selectionModeToggle")
            }
    ...
    private func createArticleNote(articleId: NSManagedObjectID) {
        ...
        do {
            ...
            ZeezLogger.error(ZeezLogger.learning, "Error creating article note", error: error)
        }
    }
}
