...
struct LearnQuickNoteView: View {
    ...
    private var header: some View {
        HStack {
            ...
            .accessibilityHint(isExpanded ? "Hide note editor" : "Show note editor")
            .accessibilityIdentifier("expandCollapseNoteButton")
            ...
            .accessibilityLabel("Quick Note, \(category.rawValue) category")
            .accessibilityHint("Tap to change note category")
            .accessibilityIdentifier("quickNoteHeader")
            ...
            .accessibilityHint(isPinned ? "Allow note to be dragged" : "Keep note in fixed position")
            .accessibilityIdentifier("pinNoteButton")
            ...
            .accessibilityHint("Close this quick note without saving")
            .accessibilityIdentifier("closeQuickNoteButton")
        }
        .padding(8)
    ...
    private var noteEditor: some View {
        VStack(spacing: 8) {
            TextField("Title (optional)", text: $title)
                ...
                .accessibilityHint("Enter an optional title for your note")
            ...
            HStack {
                ...
                .accessibilityHint("Save the note to your collection")
                ...
                .accessibilityHint("Clear all note content")
                .accessibilityIdentifier("clearNoteButton")
            }
            .padding(8)
        }
    }
    ...
    private func createNote() -> SleepNote {
        ...
        do {
            ...
            ZeezLogger.error(ZeezLogger.learning, "Error saving quick note", error: error)
        }
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItem(placement: .navigationBarTrailing) {
                Button("Done") { dismiss() }
                .accessibilityLabel("Close related content")
                .accessibilityHint("Return to quick note")
                .accessibilityIdentifier("closeRelatedContentButton")
            }
        }
    }
}
