...
struct LearnSearchView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .accessibilityHint("Search for articles, notes, and highlights")
            ...
            .toolbar {
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    .accessibilityHint("Close search view")
    ...
    private func filterButton(for filter: SearchFilter) -> some View {
        ...
        .accessibilityLabel("Filter by \(filter.rawValue.lowercased())")
        .accessibilityHint(selectedFilter == filter ? "Currently selected filter" : "Tap to filter by \(filter.rawValue.lowercased())")
        .accessibilityIdentifier("filterButton_\(filter.rawValue.lowercased())")
    }
}
