...
enum SleepPosition: String {
    ...
    var impactScore: Int {
        ...
        case .unknown: return 50   // Neutral score when position cannot be determined
        }
    }
    ...
    var drawbacks: [String] {
        ...
        case .unknown:
            return [
                "Unable to provide position-specific guidance",
                "Sensor data insufficient for analysis",
                "Consider adjusting device placement"
            ]
        }
    }
}
