...
- [ ] Done *(WIP — ~80% landed; see HANDOVER.md "2.4 remaining": finish viewContext-confinement sweep in 4 test files, single shared SKTestSession, full plan green ×2, CI first run, UI-test status)*
