...
- [x] Done *(full ZeezTests 144/144 green ×2 consecutively; ZeezUITests 10/10 and kept in the scheme's test action. ⚠️ `.github/workflows/tests.yml` is authored but has NEVER executed — verify on the first push that reaches GitHub Actions; the Xcode path-selection step may need a bump.)*
